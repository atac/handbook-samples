...
const char help_message[] =
"\n"
"dump - export data from a chapter 10 file\n"
"\n"
"Usage:\n"
"    dump <src> [--output OUT]... [options]\n"
"    dump <src> [--channel CHANNEL]... [options]\n"
"    dump <src> [--exclude CHANNEL]... [options]\n"
"    dump <src> [--type TYPE]... [options]\n"
"    dump --help\n"
"\n"
"Options:\n"
"    --help                Show this message.\n"
"    --output OUT          The directory to place files [default: .].\n"
...
int elems_to_args(Elements *elements, DocoptArgs *args, bool help,
    ...
    for (i=0; i < elements->n_arguments; i++) {
        ...
        if (!strcmp(argument->name, "<src>")) {
            args->src = argument->value;
        }
    }
    return 0;
}
...
DocoptArgs docopt(int argc, char *argv[], bool help, const char *version) {
    ...
    Option options[] = {
        ...
        {NULL, "--output", 1, 0, NULL},
        {NULL, "--type", 1, 0, NULL}
    };
    Elements elements = {0, 1, 5, commands, arguments, options};
