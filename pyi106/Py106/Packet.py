...
class DataType(object):
    ...
    types = [('UART_FMT_0', 'UART', 0x50),
             ('USER_DEFINED', 'User Defined', 0x00),
             ('PCM_FMT_0', 'PCM Format 0', 0x08),
             ('PCM_FMT_1', 'PCM Format 1', 0x09),
             ('COMPUTER_2', None, 0x02),
             ('COMPUTER_3', None, 0x03),
             ('COMPUTER_4', 'Computer Generated 4', 0x04),
             ('COMPUTER_5', 'Computer Generated 5', 0x05),
             ('COMPUTER_6', 'Computer Generated 6', 0x06),
             ('COMPUTER_7', 'Computer Generated 7', 0x07),
             ('VIDEO_FMT_2', 'Video Format 2', 0x42),
             ('VIDEO_FMT_1', 'Video Format 1', 0x41),
             ('VIDEO_FMT_0', 'Video Format 0', 0x40),
             ('IRIG_TIME', 'Time', 0x11),
             ('DISCRETE', 'Discrete', 0x29),
             ('ANALOG', 'Analog', 0x21),
             ('RECORDING_INDEX', 'Index', 0x03),
             ('IMAGE_FMT_1', 'Image Format 1', 0x49),
             ('IMAGE_FMT_0', 'Image Format 0', 0x48),
             ('PARALLEL_FMT_0', 'Parallel', 0x60),
             ('RECORDING_EVENT', 'Event', 0x02),
             ('ARINC_429_FMT_0', 'ARINC 429', 0x38),
             ('ETHERNET_FMT_0', 'Ethernet', 0x68),
             ('COMPUTER_0', None, 0x00),
             ('COMPUTER_1', None, 0x01),
             ('TMATS', 'TMATS', 0x01),
             ('MIL1553_FMT_1', '1553', 0x19),
