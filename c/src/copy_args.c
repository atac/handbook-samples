...
const char help_message[] =
"copy - create a complete or partial duplicate of a chapter 10 file\n"
"\n"
"Usage:\n"
"    copy <src> <dst> [--channel CHANNEL]... [options]\n"
"    copy <src> <dst> [--exclude CHANNEL]... [options]\n"
"    copy <src> <dst> [--type TYPE]... [options]\n"
"    copy --help\n"
"\n"
"Options:\n"
...
int elems_to_args(Elements *elements, DocoptArgs *args, bool help,
    ...
    for (i=0; i < elements->n_arguments; i++) {
        ...
        if (!strcmp(argument->name, "<dst>")) {
            args->dst = argument->value;
        } else if (!strcmp(argument->name, "<src>")) {
...
DocoptArgs docopt(int argc, char *argv[], bool help, const char *version) {
    ...
    Elements elements = {0, 2, 4, commands, arguments, options};
